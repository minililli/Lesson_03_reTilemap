...
public class RoadTile_CustomRuleTile : Tile
{
    ...
    Quaternion GetRotation(TileDirection mask)
    {
        ...
        switch (mask)
        {
            case TileDirection.East:
            case TileDirection.West:
            case TileDirection.East | TileDirection.West:               // ㅡ → ㅣ

            case TileDirection.North | TileDirection.West:              // ㄱ → 」   

            case TileDirection.All & ~TileDirection.West:    // ㅗ → ㅏ

                rotate = Quaternion.Euler(0, 0, -90);
                break;

            case TileDirection.North | TileDirection.East:              //「 → ㄴ

            case TileDirection.All & ~ TileDirection.North: //ㅏ → ㅜ
                rotate = Quaternion.Euler(0, 0, -180);
                break;

            case TileDirection.South | TileDirection.East:              //ㄴ → 「

            case TileDirection.All & ~TileDirection.East:    //ㅜ → ㅓ
